...
import med.vol.api.domain.consulta.validacao.agendamento.ValidadorAgendamentoDeConsulta;
import med.vol.api.domain.consulta.validacao.cancelamento.ValidadorCancelamentoDeConsulta;
...
public class AgendaDeConsultas {
    ...
    public void cancelar(DadosCancelamentoConsulta dados) throws ValidacaoException {
        ...
        for (ValidadorCancelamentoDeConsulta v : validadoresCancelamento) {
            v.validar(dados);
        }
